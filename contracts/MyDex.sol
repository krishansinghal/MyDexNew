...
contract MyDex {
    ...
    function addLiquidity(
        ...
        require(IERC20(tokenA).allowance(msg.sender, address(this)) >= amountADesired, "Insufficient allowance for token A");
        require(IERC20(tokenB).allowance(msg.sender, address(this)) >= amountBDesired, "Insufficient allowance for token B");
